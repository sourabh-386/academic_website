...
import './UniversityComp1.css'
import Slide from '../Homepagestuf/slide/Slide'

const uniimage=img ;

const unidata=`Lorem ipsum dolor sit amet consectetur adipisicing elit. Id tenetur, molestiae deleniti quod, blanditiis animi corrupti porro ipsa error iusto beatae ipsam a aliquid qui eum. Tempora dicta maxime beatae
...
const UniversityComp1 = () => {
    return (
        <div >
            <Slide />
            <div className='uni'>
                <h1>About University</h1>
                <img src={uniimage} alt=" img" />
                <p>{unidata}
                </p>
            </div>
            <div className="multi">
...
export default UniversityComp1